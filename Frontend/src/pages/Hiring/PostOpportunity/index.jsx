...
import apiClient from "@/lib/apiClient"; // Adjust based on your setup
import { GET_HIRING_INFO, POST_HIRING_INTO } from "@/utils/Constant";
import { toast } from "sonner";

// --- ANIMATION VARIANTS (Matching your Find component) ---
...
const PostOpportunity = () => {
  ...
  // --- REQUIRED FIELDS (only minimal change) ---
  ...
  const handlePost = async () => {
    // validation guard - minimal, non-invasive
    if (!isFormValid()) {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-2 max-w-md font-medium">
              Use our AI engine to transform raw job descriptions into
              structured, auto-expiring posts.
            </p>
          </div>
          ...
          <div className="bg-[#292b36] border border-slate-800 rounded-2xl p-4 flex items-center gap-4 shadow-xl">
            ...
            <div>
              <p className="text-white font-black leading-none text-xl">
                AI Ready
              </p>
        ...
        {/* --- AI RAW INPUT (Styled like your Search Bar) --- */}
        <div className="bg-[#292b36] border border-slate-800 rounded-[2rem] p-6 shadow-2xl relative overflow-hidden">
          ...
          <textarea
            ...
            placeholder="Paste your job description here (e.g., Hiring React intern at Google...)"
          ...
          >
            {isAnalyzing ? "Processing..." : "Analyze Description"}{" "}
            <FiArrowRight size={16} />
          </button>
        </div>
      </motion.div>

      {/* --- EDITABLE RESULT GRID (Matching your Mentor Grid) --- */}
      <AnimatePresence>
        {showForm && (
          <motion.div
          ...
          >
              ...
              <div className="space-y-4 relative z-10">
                ...
                <textarea
                  ...
                  onChange={(e) =>
                    setParsedData({
                      ...parsedData,
                      companyDiscription: e.target.value,
                    })
                  }
            ...
            <div className="md:col-span-2 lg:col-span-3 bg-[#292b36] rounded-[2rem] p-8 border border-slate-800 shadow-xl relative">
              <div className="flex items-center gap-3 mb-6">
                <span className="text-purple-500 bg-purple-500/10 p-2 rounded-lg">
                  <FiTerminal />
                </span>
                <h3 className="text-xs font-black text-slate-200 uppercase tracking-[0.2em]">
              ...
              <textarea
                ...
                onChange={(e) =>
                  setParsedData({ ...parsedData, requirements: e.target.value })
                }
              ...
              <div className="mt-8 flex items-center justify-between gap-4">
                ...
                {/* ONLY minimal change: disable when invalid */}
                <button
                  onClick={handlePost}
