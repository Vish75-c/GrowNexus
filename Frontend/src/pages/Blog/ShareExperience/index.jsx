        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
          <div>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-500">Creator Studio</span>
            </div>
            <h1 className="text-4xl font-black text-white leading-none">Share Your <span className="text-blue-500">Experience.</span></h1>
          </div>
          
          <Button 
            onClick={handlePublish}
            disabled={loading}
            className="bg-blue-600 hover:bg-blue-500 text-white rounded-2xl px-10 py-6 font-black uppercase text-[11px] tracking-widest transition-all shadow-xl shadow-blue-900/20 group"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-8 space-y-8">
            <div className="bg-[#292b36] border border-slate-800 rounded-[2.5rem] p-8 shadow-2xl">
              <input 
                ...
                className="w-full bg-transparent text-3xl font-black text-white outline-none mb-6 placeholder:text-slate-700 tracking-tight"
              />
              ...
              <textarea 
                ...
                className="w-full min-h-100 bg-transparent text-slate-300 text-lg leading-relaxed outline-none resize-none placeholder:text-slate-800 custom-scrollbar"
              />
            </div>
          </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              ...
              <input type="file" ref={fileRef} className="hidden" onChange={handleImage} />
            </div>
            ...
            <div className="bg-[#292b36] border border-slate-800 rounded-[2.5rem] p-8 space-y-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-widest text-white">Tags</span>
              </div>
              
              <div className="flex flex-wrap gap-2">
                <AnimatePresence>
                  {tags.map((tag) => (
                    <motion.div initial={{ scale: 0.8 }} animate={{ scale: 1 }} exit={{ scale: 0.8 }} key={tag}>
                      <Badge className="bg-[#1f202a] border border-slate-700 text-slate-400 py-1.5 px-3 rounded-lg flex items-center gap-2 hover:border-blue-500 transition-all group">
                        ...
                        <X size={12} className="cursor-pointer group-hover:text-red-500" onClick={() => removeTag(tag)} />
                      </Badge>
                    </motion.div>
                  ))}
                </AnimatePresence>
              ...
              <div className="relative">
                ...
                />
                <button onClick={addTag} className="absolute right-3 top-2.5 text-slate-600 hover:text-blue-500">
                  <Plus size={18} />
                </button>
              </div>
            </div>
            ...
            <div className="bg-blue-600/5 border border-blue-500/10 rounded-[2.5rem] p-8">
               <div className="flex items-center gap-2 mb-4">
                 ...
                 <span className="text-[10px] font-black uppercase tracking-widest text-blue-500">Tips</span>
               </div>
